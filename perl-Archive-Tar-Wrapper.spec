...
Version  : 0.41
Release  : 32
URL      : https://cpan.metacpan.org/authors/id/A/AR/ARFREITAS/Archive-Tar-Wrapper-0.41.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/A/AR/ARFREITAS/Archive-Tar-Wrapper-0.41.tar.gz
...
%prep
%setup -q -n Archive-Tar-Wrapper-0.41
cd %{_builddir}/Archive-Tar-Wrapper-0.41
pushd ..
cp -a Archive-Tar-Wrapper-0.41 buildavx2
popd
...
cp %{_builddir}/Archive-Tar-Wrapper-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Archive-Tar-Wrapper/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
if test -f Makefile.PL; then
